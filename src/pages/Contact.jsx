      ...
      <section id="contact-form" className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-12 transition">
        ...
        >
          ...
          <div className="space-y-4 ">
            <input className="w-full  p-3 rounded-lg shadow-xl" placeholder="Full Name" />
            <input className="w-full  p-3 rounded-lg shadow-xl" placeholder="Email" />
            <input className="w-full  p-3 rounded-lg shadow-xl" placeholder="Phone Number" />
            ...
            <textarea className="w-full p-3 rounded-lg shadow-xl" rows="4" placeholder="Your Message" />
          </div>

          <button className="mt-6 bg-primary text-black font-bold px-6 py-3 rounded-full hover:scale-105 transition ">
            Submit
          </button>
        </motion.form>
